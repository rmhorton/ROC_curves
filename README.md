...
* HTML prototypes of interactive visualizations to add to the [TurtleROC](https://github.com/rmhorton/TurtleROC) package:
	...
	- [ROC Utility](https://github.com/rmhorton/ROC_curves/blob/master/ROC_utility/ROC_utility.html)) app showing cost-based utility on the background of the ROC plane.
